...
# docker run --rm -it --cap-add SYS_ADMIN --security-opt apparmor:unconfined --add-host=host.docker.internal:host-gateway -v /tmp:/tmp -v /home/ubuntu/github/python-ismrmrd-server:/data stebo85/$containerName /bin/bash
